...
def api():
    ...
    async def telegram_setup(request: Request):
        # This endpoint is intentionally idempotent. The deployment workflow
        # calls it after deployment and it derives the public Modal URL from
        # the request itself, so no Telegram token ever enters GitHub Actions.
    ...
    async def telegram_webhook(
        ...
        # The webhook is protected by the secret path generated by the
        # deployment URL plus Modal HTTPS. Telegram retries non-2xx responses.
